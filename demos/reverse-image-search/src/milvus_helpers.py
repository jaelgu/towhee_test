import sys
from config import MILVUS_HOST, MILVUS_PORT, INDEX_FILE_SIZE, METRIC_TYPE, DIM_DICT
...
class MilvusHelper:
    ...
    def get_dim(self, collection_name):
        dim = DIM_DICT[collection_name]
        return dim
        ...
        try:
            if not self.client.has_collection(collection_name)[1]:
                collection_param = {
                    ...
                    'dimension': self.get_dim(collection_name),
